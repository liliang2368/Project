...
public class javaMailUtil {
	...
	//发送的邮箱 内部代码只适用qq邮箱
	private static final String USER = "2991180057@qq.com";
	//授权密码 通过QQ邮箱设置->账户->POP3/IMAP/SMTP/Exchange/CardDAV/CalDAV服务->开启POP3/SMTP服务获取
	private static final String PWD = "bbbzxnmkthljddhf";
	...
	public static void send(String variWd,String email) {
		javaMailUtil mail = new javaMailUtil();
		mail.setSubject("萌神点餐系统注册验证码");
		mail.setContent("来自李阳大帅哥的礼物，打死也不要告诉别人，那就是你的验证码！！ 请妥善保存好哈 \n" + variWd);
